...
declare const messages: {
  ...
  "CheckoutPage": {
    ...
    "delivereeTooltip": "Deliveree works like a vehicle rental — the vehicle will head to your location regardless of how much you're shipping. Great for medium to large shipments.",
    "forwarderTooltip": "Forwarder uses a Less Than Truckload (LTL) system — you only pay for the space your goods take up in the truck. Cargo is shared with other shippers, making it more cost-effective for medium-sized shipments.",
