...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      <CheckIcon className="ml-auto opacity-0 group-has-data-[slot=command-shortcut]/command-item:hidden group-data-[checked=true]/command-item:opacity-100 size-3.5" />
    </CommandPrimitive.Item>
  );
}
